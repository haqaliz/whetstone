...
#: The probe's synthetic journal: 37 rollouts for candidate "one" (5 solved) at a named spend.
#: Denominators 37/41 collide with nothing in the six existing artifacts (their own are 1, 62,
#: 63, 64, 189, 299, 300), so the render is disjoint from every committed home by construction.
